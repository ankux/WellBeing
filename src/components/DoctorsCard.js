...
const DoctorsCard = () => {
  ...
  return (
    <div className="flex flex-col font-poppins sm:flex-row items-center justify-evenly min-h-auto p-4 py-20">
      <div className='relative w-full max-w-xl'>
        <h2 className=' sm:text-left text-4xl md:text-6xl font-bold mb-6 md:mb-8'>  Meet our Specialists </h2>
